...
# See "api key" here: https://github.com/fraybetancur/f-enketo-express/tree/master/config#linked-form-and-data-server.
...
# See "https://github.com/fraybetancur/f-enketo-express/blob/master/setup/docker/create_config.py#L14
ENKETO_ENCRYPTION_KEY=${ENKETO_ENCRYPTION_KEY}
# Canonically a 50-character random string. For Django 1.8.13, see https://docs.djangoproject.com/en/1.8/ref/settings/#secret-key and https://github.com/fraybetancur/f-django/blob/4022b2c306e88a4ab7f80507e736ce7ac7d01186/django/core/management/commands/startproject.py#L29-L31.
